        ...
        <section className="py-16 md:py-24 relative overflow-hidden bg-[#000B1A]">
            ...
            <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-gradient-to-br from-[#001A33] to-[#001222] border border-[#A67C00]/30 p-12 rounded-2xl shadow-[0_0_50px_rgba(166,124,0,0.15)] relative overflow-hidden group"
                >
                    {/* Efecto de brillo al hacer hover */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:animate-shimmer pointer-events-none" />

                    <div className="w-20 h-20 mx-auto bg-[#001A33] rounded-full flex items-center justify-center border-2 border-[#A67C00] mb-6 shadow-lg relative">
                    ...
                    <button
                        onClick={onOpenChat}
                        className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-[#A67C00] px-8 py-3 rounded-full font-cinzel tracking-widest uppercase transition-all duration-300 hover:shadow-[0_0_20px_rgba(166,124,0,0.4)]"
                    >
